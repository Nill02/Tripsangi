            ...
            <div className='flex flex-col space-y-2'>
              ...
              {user ? (
                ...
                <div className='mt-2 flex gap-2'>
                  <Link to='/login' onClick={() => setOpen(false)} className='px-3 py-2 border border-primary text-primary rounded-md'>Login</Link>
                  <Link to='/register' onClick={() => setOpen(false)} className='px-3 py-2 btn btn-primary'>Register</Link>
                </div>
              )}
            </div>
          </div>
