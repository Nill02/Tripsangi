...
export default function Navbar() {
  ...
  return (
    <nav className='bg-surface dark:bg-[#071028] shadow-sm'>
      <div className='max-w-7xl mx-auto px-4'>
        <div className='flex items-center justify-between h-16'>
          <div className='flex items-center gap-4'>
            <Link to='/' className='flex items-center gap-3'>
              <div className='w-10 h-10 rounded-full overflow-hidden flex items-center justify-center bg-white dark:bg-[#071028]'>
                {!logoError ? (
                  <img
            ...
            <div className='hidden md:flex items-center space-x-4'>
              <Link
                to='/locations'
                className='flex items-center px-3 py-2 rounded-md text-primary hover:text-secondary'
              >
          ...
          <div className='flex items-center gap-4'>
            <div className='hidden md:flex items-center space-x-3'>
              ...
              {user ? (
                ...
                <>
                  <Link to='/login' className='btn btn-ghost border-primary text-primary'>
                    Login
                  </Link>
            ...
            <div className='flex flex-col space-y-2'>
              <div className='flex items-center justify-between'>
                <div>
                  <Link
                    ...
                    className='px-3 py-2 rounded-md text-primary hover:text-secondary'
                  >
                    Home
                  </Link>
                </div>
              ...
              {user ? (
                <button
                  ...
                  className='mt-2 px-3 py-2 btn btn-ghost'
                >
                  Logout
                </button>
              ) : (
                <div className='mt-2 flex gap-2'>
                  <Link
                    to='/login'
                    onClick={() => setOpen(false)}
                    className='px-3 py-2 border border-primary text-primary rounded-md'
                  >
                    Login
                  </Link>
                  <Link
